...
const VegMenu = () => {
  ...
  return (
    <div
      className="min-h-screen w-screen flex justify-center items-center  flex-col text-center
        md:justify-around"
      style={{
        background: "#F0F4FD",
      }}
    >
      <h1 className="font-extrabold uppercase animate-bounce text-5xl font-nunito">
        veg menu
      </h1>

      <div className="flex flex-col md:flex-row justify-center items-center font-nunito text-center">
        <div data-aos="fade-right">
          <div className="flex flex-col justify-center items-center  mb-10 mx-10 px-10 py-5  bg-yellow-400 shadow-xl rounded-2xl h-4/5 w-80 md:w-96 transform hover:scale-110 transition ease-in-out duration-500">
            <img
              src={process.env.PUBLIC_URL + "/assets/v1.jpg"}
              alt="veg"
              className=" w-h-64 h-64 rounded-3xl"
            />
        ...
        <div data-aos="fade-up">
          <div className="flex flex-col justify-center items-center  mb-10 mx-10 px-10 py-5  bg-yellow-400 shadow-xl rounded-2xl h-4/5 w-80 md:w-96 transform hover:scale-110 transition ease-in-out duration-500">
            <img
              src={process.env.PUBLIC_URL + "/assets/v2.jpg"}
              alt="veg"
              className=" w-h-64 h-64 rounded-3xl"
            />
            <h3 className="font-bold uppercase text-lg md:text-xl md:flex-col">
        ...
        <div data-aos="fade-left">
          <div className="flex flex-col justify-center items-center  mb-10 mx-10 px-10 py-5  bg-yellow-400 shadow-xl rounded-2xl h-4/5 w-80 md:w-96 transform hover:scale-110 transition ease-in-out duration-500">
            <img
              src={process.env.PUBLIC_URL + "/assets/v3.jpg"}
              alt="veg"
              className=" w-h-64 h-64 rounded-3xl"
            />
            <h3 className="font-bold uppercase text-lg md:text-xl md:flex-col">
